...
require(['/assets/vs/editor/editor.main'], function() {
  ...
  /* Methods (Instance) */ monaco.languages.registerCompletionItemProvider('lua', {triggerCharacters: [":"], provideCompletionItems: function () {return {suggestions: [
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Method,
      detail: "Method",
      documentation: {value: "[TBA as of 1st April 2021. Go fork https://github.com/EthanMcBloxxer/Rosploco and propose the documentation to be added if it exists.]"},
      filterText: ":GetActor()",
  ...
  /* Exploiting (Environment) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the environment that will be applied to each script ran by the executor."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the global environment for the LocalScript state."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the environment of `script`."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the Lua registry."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns all functions and userdata values within the GC. Passing true will also return tables."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a list of all instances within the game."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a list of all instances parented to `nil` within the game."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a list of all local and module scripts within the game."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns all ModuleScripts loaded in the game."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Fires all the connections connected to the signal with the provided arguments."},

      insertText: "firesignal(${1:signal}, $0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Fires the designated ClickDetector with provided distance. If distance isn't provided, it will default to 0."},

      insertText: "fireclickdetector(${1:path}, ${2:distance})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Fires the designated ProximityPrompt with the given distance."},

      insertText: "fireproximityprompt(${1:path}, ${2:distance})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Fakes a .Touched event to ToTouch with `path`. The Toggle argument must be either 0 or 1 (for fire/un-fire). The ToTouch argument must have a child with class TouchTransmitter in order for this function to work."},

      insertText: "firetouchinterest(${1:path}, ${2:basepart}, ${3:toggle})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns true if the Part is owned by the player."},

      insertText: "isnetworkowner($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the hidden property Property from Object. Errors if the property does not exist."},

      insertText: "gethiddenproperty(${1:path}, ${2:property})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets the hidden property `property` with `value` from `path`. Errors if the property does not exist."},

      insertText: "sethiddenproperty(${1:path}, ${2:property}, ${3:value})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets the player's SimulationRadius. If `max` is specified, it will set that as well."},

      insertText: "setsimulationradius(${1:radius}, ${2:max})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the identity for the current thread."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the script from thread even if the script does `script = nil`"},

      insertText: "getscriptfromthread($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "gethui",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a holder made for GUIs to be parented in. It hides children from FindFirstChild attacks and does not fire game.DescendantAdded."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets whether a property is hidden or not using value. Returns old visibility status."},

      insertText: "sethidden(${1:path}, ${2:property}, ${3:value})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "ishiddenproperty",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns true if property is hidden, false is the property isn't hidden, nil if the property doesn't exist."},

      insertText: "ishiddenproperty(${1:path}, ${2:property})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "getproperties",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns an array of property names on the provided Instance."},

      insertText: "getproperties($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a array of hidden property names on said object."},

      insertText: "gethiddenproperties($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Gets the LuaU bytecode of a script."},

      insertText: "getscriptbytecode($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "dumpstring",
      ...
      insertText: "dumpstring($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  /* Exploiting (Script) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Gets the script that is calling this function."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Gets a bare function from the script passed. This is not the original function of the script and will not have upvalues/environment correctly defined."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a SHA384 hash of the script's bytecode. You can use this to detect changes of a script."},

      insertText: "getscripthash($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  /* Exploiting (Table) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Retrieve the metatable of the provided table irregardless of the metatable's `__metatable` field. Returns nil if it doesn't exist."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets object's metatable to metatable even if the __metatable field exists in object's metatable."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets object's read-only value to `toggle`."},

      insertText: "setreadonly(${1:object}, ${2:toggle})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "isreadonly",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the provided table's read-only condition."},

      insertText: "isreadonly($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  /* Exploiting (Input) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns if the main window is in focus. This must return true for any other mouse/keyboard function to work.\n\nAKA\n`isrbxactive()`\n`isRobloxFocused()`"},
      filterText: "iswindowactive+isrbxactive+isRobloxFocused",

      insertText: "iswindowactive()",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "keypress",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Simulates a key press for the specified [keycode](https://docs.microsoft.com/windows/desktop/inputdev/virtual-key-codes)."},

      insertText: "keypress($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "keyrelease",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Releases [key](https://docs.microsoft.com/windows/desktop/inputdev/virtual-key-codes) on the keyboard."},

      insertText: "keyrelease($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "mouse1click",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Simulates a full left mouse button press.\n\nAKA\n`MouseButton1Click()`"},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Simulates a left mouse button press without releasing it.\n\nAKA\n`MouseButton1Press()`"},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Simulates a left mouse button release.\n\nAKA\n`MouseButton1Release()`"},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Simulates a full right mouse button press.\n\nAKA\n`MouseButton2Click()`"},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Clicks down on the right mouse button.\n\nAKA\n`MouseButton2Press()`"},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Simulates a right mouse button release.\n\nAKA\n`MouseButton2Release()`"},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Scrolls the mouse wheel virtually by the provided integer pixels."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Moves the mouse cursor relatively to the current mouse position by coordinates `x` and `y`."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Moves your mouse to the `x` and `y` coordinates in pixels from top left of the main window."},

      insertText: "mousemoveabs(${1:x}, ${2:y})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  /* Exploiting (Closure) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Hooks the first given function, replacing it with the second given function. The old function is returned, you must use this function in order to call the original function."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Pushes a new CClosure that invokes the function upon call. Used for metatable hooks."},
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns whether the provided function is a CClosure."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns whether the provided function is a closure created by the exploit."},

      insertText: "checkclosure($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  /* Exploiting (Reflection) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns true if the current thread is a thread created by the executor. Checkcaller does NOT check the call stack of the function, if you call a game function then it calls out to checkcaller, the result will be true."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns true if the function provided is an LClosure."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Decompiles Script and returns the decompiled script with timeout. If the decompilation fails, then the return value will be an error message."},

      insertText: "decompile(${1:object}, nil, ${3:timeout})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  /* Exploiting (Filesystem) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Reads the contents of the file located at the specified path and returns it. If the file does not exist, it errors."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Writes contents to the supplied path."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Appends content to the file contents at the specified path. If the file does not exist, it errors."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Loads in the contents of a file as a chunk and returns it if compilation is successful."},

      insertText: "loadfile(${0})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "listfiles",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a table of files in folder."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns if path is a file or not."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Creates a new folder at the provided path."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Deletes the folder in the supplied path, if no folder exists, it errors."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Deletes the file in the supplied path, if no file exists, it errors."},
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Opens a read file dialog with title and filter. "},

      insertText: "readdialog(${1:title}, ${2:filter})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "writedialog",
      ...
      insertText: "writedialog(${1:title}, ${2:filter}, ${3:data})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "dofile",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Attempts to load and execute the file located in the given path."},

      insertText: "dofile($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  /* Exploiting (Miscellaneous) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets the provided value to the clipboard."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets fflag with value. Must be run before the game loads."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the namecall method if the function is called in an __namecall metatable hook."},

      insertText: "getnamecall()",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets the current namecall method to the new namecall method. Must be called in a __namecall metatable hook."},
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Gets a list of special properties for MeshParts, UnionOperations, and Terrain instances."},

      insertText: "getspecialinfo($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "saveinstance",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Saves the current game into your workspace folder. Arguments differ between exploits, but the last argument is often a table of options."},

      insertText: "saveinstance($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns content of the PhysicalConfigData of the passed object.\nDeprecated in favor of\n`gethiddenproperty(object, \"PhysicalConfigData\")`"},
      tags: [monaco.languages.CompletionItemTag.Deprecated],

      insertText: "gethiddenproperty($0, \"PhysicalConfigData\")",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  ...
  /* Drawing Library */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
      {
        label: "Drawing",
        kind: monaco.languages.CompletionItemKind.Module,
        detail: "Library",
  ...
  /* Debug (Exploiting) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
...

    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Retrieve the constants in the given function or at the given level."},

      insertText: "debug.getconstants($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the constant at the given index in the given function or level."},

      insertText: "debug.getconstant($0, ${1:index})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets the constant at the given index in the given function or level."},

      insertText: "debug.setconstant($0, ${1:index}, ${2:value})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Retrieve the upvalues in the given function or at the given level."},

      insertText: "debug.getupvalues($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns the upvalue at the given index in the given function or level."},

      insertText: "debug.getupvalue($0, ${1:index})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "debug.setupvalues",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets the upvalue at the given index in the given function or level."},

      insertText: "debug.setupvalues($0, ${1:index}, ${2:value})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a table containing the inner functions of the given function. Note these functions will not have upvalues, use `debug.getproto` with activated `true` to get a list of instances."},

      insertText: "debug.getprotos($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Gets the inner function of the given function at the provided index. When `activated` is true it will return a table of functions."},

      insertText: "debug.getproto($0, ${1:index}, ${2:activated})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "debug.setproto",
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Replaces the given function at `index` with function `replacement` at the given level/function."},

      insertText: "debug.setproto($0, ${1:index}, ${2:replacement})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Gets the method stack at the given level or function."},

      insertText: "debug.getstack($0)",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Set the stack indice at `indice` to value `value` at the given level or function."},

      insertText: "debug.setstack($0, ${1:indice}, ${2:value})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Sets the metatable of the given table to the given metatable."},

      insertText: "debug.setmetatable(${1:table}, ${2:metatable})",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
    ...
    },
    {
      ...
      kind: monaco.languages.CompletionItemKind.Function,
      detail: "Function",
      documentation: {value: "Returns a table of info pertaining to the given function/level."},

      insertText: "debug.getinfo($0, \"${2:flnSu}\")",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
  ]}}});
  /* Websocket (Exploiting) */ monaco.languages.registerCompletionItemProvider('lua', {provideCompletionItems: function () {return {suggestions: [
    {
      ...
      insertText: "${1:syn.}${2|websocket,WebSocket|}.connect(\"${3:url}\")",
      insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    },
    {
      label: "WebSocket",
      ...
      insertText: [
        "local ${1:WebSocket} = ${2:syn.}${3|websocket,WebSocket|}.connect(\"${4:url}\")",
        "",
